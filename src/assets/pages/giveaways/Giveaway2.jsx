...
const giveaway2 = () => {
  ...
  return (
    <div className="w-screen h-screen overflow-x-hidden flex max-[1064px]:flex-col-reverse">
          ...
          {submissionResult === 'success' && (
            ...
            >
              ...
              <div ref={lottieRef} className="w-full h-fit flex items-center justify-center">
                ...
                <p className="text-base">Get designs by clickiing <a href="https://www.figma.com/community/file/1507461805891841591" className="text-blue-400 underline" target="_blank"> here</a></p>
      ...
      >
        <img
          src="../../images/giveaways/giveaway2.webp"
          alt="image"
