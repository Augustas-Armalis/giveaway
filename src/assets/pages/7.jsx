...
const FIGMA_LINK = "https://www.figma.com/design/MTpvXIXPnTGrAY5mE4IzvD/8-Free-Hero-Designs?node-id=0-1&t=wVVjp83EuMIfDKJl-1";
...
const giveaway7 = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const groupResponse = await fetch('https://connect.mailerlite.com/api/groups?filter[name]=giveawaylunor', {
        method: 'GET',
        headers: {
