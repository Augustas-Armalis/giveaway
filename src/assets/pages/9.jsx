...
const HERO_IMAGE_SRC = "../images/giveaways/giveaway9.webp";
const HERO_TITLE = "8 Free SaaS Hero-Designs";
const FIGMA_LINK = "https://www.figma.com/design/9bSHmbAhKY3s78OUj8SqRt/8-SaaS-Hero-designs-%7C-Lunor?node-id=0-1&t=G9wAK9uaXGi1L6TR-1";
          ...
          {submissionResult === 'success' && (
            ...
            >
              ...
              <div ref={lottieRef} className="w-full h-fit flex items-center justify-center">
                ...
                <p className="text-base !mt-4 !px-[42px] text-center max-w-[320px]">P.S. Check out 100+ of these designs on <a href="https://lunor.design" className="text-blue-400 underline" target="_blank">Lunor</a></p>
